...
main() {
  ...
  gh pr create --base main --title "feat(vscode): update to version $VSCODE_EXACT_VERSION" --body "$PR_BODY" --reviewer @brevdev/code-server-reviewers --repo brevdev/code-server --draft
}
